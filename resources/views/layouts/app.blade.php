  ...
  <body class="cbp-spmenu-push">
    ...
    <div class="main-content">
      ...
      <div class="footer">
        <p>
          ...
          <a href="" target="_blank">Ronganco</a>
        </p>
      </div>
      <!--//footer-->
    </div>
    ...
    <script type="text/javascript">
        $('.show_video').click(function(){
                var moive_id = $(this).data('movie_video_id');
                ...
                $.ajax({
                    ...
                    method:"POST",
                    dataType:"JSON",
                    data:{movie_id:moive_id,episode_id:episode_id},
                    success:function(data){
