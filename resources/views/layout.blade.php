...
<html lang="vi">
   ...
   <body class="home blog halimthemes halimmovies" data-masonry="">
               ...
               <div class="collapse navbar-collapse" id="halim">
                  <div class="menu-menu_1-container">
                     <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                        ...
                        <li class="mega dropdown">
                           <a title="Tài khoản" href="#" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">Tài khoản: @if(Auth::user()) : {{Auth::user()->name}} <span class="caret"></span> @endif</a>
                           <ul role="menu" class=" dropdown-menu">
                              @if(!Auth::user())
                              ...
                              @else
                              <li><a title="đăng xuất" href="{{route('logout-home')}}">Đăng xuẩt</a></li>
                              <li><a title="đăng xuất" href="{{route('get.payment')}}">Nạp tiền</a></li>
                              <li><a title="đăng xuất" href="{{route('get.vip')}}">Mua VIP</a></li>
      ...
      <div id="fb-root"></div>
      <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v18.0" nonce="inj0eZ8B"></script>
