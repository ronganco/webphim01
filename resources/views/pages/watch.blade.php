                        ...
                        <div role="tabpanel" class="tab-pane active server-1" id="server-0">
                           <div class="halim-server">
                              <ul class="halim-list-eps">
                                 ...
                                 @if($sotap->vip == 0 || ($user != null ||  $user->vip ==1))
                                    <a href="{{url('xem-phim/' .$movie->slug.'/tap-'.$sotap->episode)}}">
                                    <li class="halim-episode"><span class="halim-btn halim-btn-2 {{$tapphim==$sotap->episode ? 'active' : ''}} halim-info-1-1 box-shadow" data-post-id="37976" data-server="1" data-episode="1" data-position="first" data-embed="0" data-title="Xem phim {{$movie->title}} - Tập {{$sotap->episode}} - {{$movie->name_eng}} - vietsub + Thuyết Minh" data-h1="{{$movie->title}}">{{$sotap->episode}}</span></li>
                                    </a>
                                 @else
                                    <a style="color:green;cursor:pointer" onclick="alert(' Tập phim này là tập vip cần mua gói vip ')">
                                       <li class="halim-episode" ><span class="halim-btn halim-btn-2 " style="color:green;cursor:pointer;font-weight:bold">{{$sotap->episode}}</span></li>
                                    </a>
