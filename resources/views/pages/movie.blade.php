                               ...
                               @endif
                                 ...
                                 @if($episode_current_list_count>0)
                                    ...
                                    @foreach($episode as $key =>$ep)
                                       @if($ep->vip == 1 && ($user == null ||  $user->vip ==0))
                                          <a style="color:green;cursor:pointer" onclick="alert(' Tập phim này là tập vip cần mua gói vip')"rel="tag">Tập {{$ep->episode}}</a>
                                       @else
                                 ...
                                 @elseif($movie->thuocphim=='phimle')
                                    @foreach($episode as $key =>$ep_le)
                                       @if($ep_le->vip == 1 && ($user == null ||  $user->vip ==0))
                                       <a style="color:green;cursor:pointer" onclick="alert(' Tập phim này là tập vipcần mua gói vip ')" rel="tag">{{$ep_le->episode}}</a>
                                       @else
